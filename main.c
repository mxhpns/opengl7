...
void createBuffer() {
    float vertices[] = {
         // vertices
        -1.0f,  0.0f, -2.0f, 1.0f, // left-bottom
         1.0f,  0.0f, -2.0f, 1.0f, // right-bottom
         0.0f,  1.0f, -2.0f, 1.0f, // top
...
void display() {
    ...
    glVertexAttribPointer(1, 4, GL_FLOAT, GL_FALSE, 0, (void*) (3*4*sizeof(float)));
